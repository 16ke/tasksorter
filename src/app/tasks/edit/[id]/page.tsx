        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-card p-6 rounded-lg shadow-md border-theme">
          ...
          <div className="flex space-x-4">
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 bg-[var(--turquoise-500)] text-white py-2 px-4 rounded-md hover:bg-[var(--turquoise-600)] focus:outline-none focus:ring-2 focus:ring-[var(--turquoise-500)] focus:ring-offset-2 disabled:opacity-50 transition-colors"
            >
            ...
            <button
              ...
              className="flex-1 bg-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500"
            >
              Cancel
            </button>
          </div>
